...
import { URL, pathToFileURL, isURLInstance } from "../../url.js";
import ModuleMap from "./module_map.js";
import ModuleJob from "./module_job.js";

import { defaultResolve, DEFAULT_CONDITIONS } from "./resolve.js";
...
class Loader {
  ...
  async eval(
    ...
    // console.log("salam", new Error().stack);

...
import {
  ...
  StringPrototypeSubstring as StringPrototypeSubstr,
...
const preserveSymlinks = false //getOptionValue('--preserve-symlinks');
const preserveSymlinksMain = false //getOptionValue('--preserve-symlinks-main');
const typeFlag = false //getOptionValue('--input-type');
import { URL, pathToFileURL, fileURLToPath } from "../../url.js";
...
function defaultResolve(specifier, context = {}, defaultResolveUnused) {
  ...
  let parsed;
  try {
    // console.log("non-parsed:", specifier)
...
// cycle
import { defaultGetFormat } from "./get_format.js";
